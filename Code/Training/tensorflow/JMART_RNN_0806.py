...
num_classes = 105 # MNIST total classes (0-9 digits)

csv_filename = '20190709JMART.csv'
model_graph_path = './model_jmart_rnn_0806'
log_path = './logs_jmart_rnn_0806/train'
ckpt_path = './model_jmart_rnn_0806/weights_final.ckpt'
...
class NetWork():
	...
	def createRNN(self):
		...
		x = tf.unstack(self.X_, time_seqlen, 1)
		...
		with tf.name_scope('Cost'):
			...
			self.loss_op = tf.reduce_mean(tf.nn.softmax_cross_entropy_with_logits(
				logits=self.logits, labels=self.Y)) + self.lossL2
...
def main():
	...
	# print train_data
	train_label = np.hsplit(train, (1, 27))[2]
	print train_label
	train_data_seq = []
	train_label_seq = []
