...
time_seqlen = 4 # time sequence length
num_hidden = 128 # hidden layer num of features
num_classes = 16 # MNIST total classes (0-9 digits)

csv_filename = '20190731TR.csv'
model_graph_path = './model_tr_rnn_0731_6'
log_path = './logs_tr_rnn_0731_6/train'
ckpt_path = './model_tr_rnn_0731_6/weights_final.ckpt'
...
def main():
	...
	print train_data
	train_data = train_data.reshape(-1,4,3)
	print train_data
	train_label = np.hsplit(train, (1, 13))[2]
