...
input_size = 4
output_size = 12
csv_filename = 'merge1_2m_3in1.csv'
model_graph_path = './model_tr_2m'
log_path = './logs_tr_2m/train'
ckpt_path = './model_tr_2m/weights_final.ckpt'
...
class NetWork():
    ...
    def __conv_2d(self, name, input_ts, kernel_size, filters, act = tf.nn.relu,
        ...
        return tf.layers.conv2d(input_ts, filters, kernel_size, padding = 'same', activation = act,
        ...
        with tf.Session() as sess:
            ...
            for epoch in range(train_epochs):
                ...
                if ((epoch + 1) % display_epochs == 0):
                    print("Epoch {:d} : Loss = {:.9f} | Train_ACC = {:.9f}".format((epoch + 1),loss,acc) )
