...
class NetWork():
    ...
    def __batch_norm(self, name, input_ts, train_flag):
        return tf.layers.batch_normalization(input_ts, training = train_flag, name = name)
