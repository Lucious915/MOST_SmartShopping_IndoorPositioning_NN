...
num_classes = 32 # MNIST total classes (0-9 digits)

csv_filename = 'merge_1m_1by1.csv'
model_graph_path = './model_tr_rnn_1by1_1m'
log_path = './logs_tr_rnn_1by1_1m/train'
ckpt_path = './model_tr_rnn_1by1_1m/weights_final.ckpt'
