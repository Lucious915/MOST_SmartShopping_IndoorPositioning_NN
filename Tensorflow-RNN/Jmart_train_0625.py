...
csv_filename = 'Jmart_data_0625.csv'#Jmart_data_0625
model_graph_path = './model_jmart_0625'
log_path = './logs_jmart_0625/train'
ckpt_path = './model_jmart_0625/weights_final.ckpt'
...
class NetWork():
	...
	def createRNN(self):
		...
		print 'is me'
		print np.array(self.logits).shape
		print 'is me'
		print np.array(self.prediction).shape
